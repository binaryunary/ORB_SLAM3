...
class System
{
  ...
  public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true,
           const bool bLocalizationOnly = false, const string &outDir="/tmp/orbslam-out", const int activeMap = 0, const int initFr = 0, const string &strSequence = std::string());
    ...
    Sophus::SE3f TrackMonocularGPS(const cv::Mat &im, const double &timestamp, GPSPos gps,
                                   const vector<IMU::Point> &vImuMeas = vector<IMU::Point>(), string filename = "");
    ...
    void SaveData();
    void SaveKeyFrameTrajectoryTUMGPS();
    void SaveMapPoints();
    void SaveSLAMEstimate();
    void SaveGPSEstimate();
